<template>
  ...
  >
    <div class="w-full max-w-5xl max-h-[90vh] overflow-y-auto bg-white rounded-t-2xl sm:rounded-2xl border-t-2 sm:border-2 border-border shadow-2xl p-4 sm:p-6">
