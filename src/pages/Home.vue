<template>
  <div class="min-h-screen bg-gradient-to-br from-background via-background to-muted pb-20">
    <div class="bg-white border-b-2 border-border px-4 sm:px-6 py-5 sm:py-6 shadow-sm">
      <div class="mb-2">
        <h1 class="text-3xl sm:text-4xl font-bold text-foreground leading-tight">CheckOut</h1>
        <p class="text-xs sm:text-sm text-muted-foreground">Vereins-Scoring & Statistiken</p>
      </div>
    </div>
